...
public class VotesSteps {
  ...
  "value": "ad"
    ...
    public void i_have_numbers_plus_one_votes_for_this(String sub_id, String image_id) {
        ...
        JsonPath getPath = new JsonPath(bodyResponse);
        List imageIdArray = getPath.getList("image_id");
        String actualImage = imageIdArray.get(lastVoteCount - 1).toString();

        Assert.assertTrue(lastVoteCount == initialVoteCount + 1);
        Assert.assertEquals(actualImage, image_id);
    }
